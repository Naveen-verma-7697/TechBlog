        ...
        <div class="container">
            <div class="row mb-2">
                <div class="col-md-4 p-1 text-center head supportive_color">
                    <img src="profile_pics/technology.jpg" style="width: 150px;height: 150px;border-radius:70%;" alt="alt"/><br><br>
                    <h4>Technology</h4>
                    <p >Empowering Developers with Knowledge – Explore, Learn, and Grow with TechBlog!</p>
                </div>
                <div class="col-md-4  p-1 text-center head supportive_color">
                   <img src="profile_pics/prog_pic.jpg" style="width: 150px;height: 150px;border-radius: 70%;" alt="alt"/><br><br>
                    <h4>knowledge</h4>
                   <p>Code is poetry, logic is art—keep building, keep learning!</p>
                 
                </div>
                <div class="col-md-4  p-1 text-center head supportive_color">
                   <img src="profile_pics/nature.jpg" style="width: 150px;height: 150px;border-radius: 50%;" alt="alt"/><br><br>
                    <h4>Nature</h4>
                   <p>Embrace Nature, Preserve the Future – Every Small Effort Counts!</p>
