...
<!--        //nav start-->
  ...
  <div class="container-fluid">
      <a class="navbar-brand" href="indexlogin.jsp"><span class="fa fa-asterisk"></span> TechBlog</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#"><span class="fa fa-bell-o"></span> Review with Naveen</a>
        </li>
